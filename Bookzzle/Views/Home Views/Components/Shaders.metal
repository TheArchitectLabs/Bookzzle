...
[[ stitchable ]] float2 perspectiveTilt(float2 position, float2 origin, float2 size, float strength) {
...
[[ stitchable ]] half4 rainbowGradient(float2 position, half4 color, float2 size, float timeOffset) {
